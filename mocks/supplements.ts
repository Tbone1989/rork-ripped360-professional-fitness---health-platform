...
export const herbalInteractions: HerbalInteraction[] = [
  ...
  },
  {
    ...
    interactsWith: ['Stimulants', 'SSRIs/SNRIs (caution)'],
    contraindications: ['Bipolar disorder (mania risk)'],
    warnings: ['May be stimulating; avoid late evening'],
    pregnancySafety: 'caution',
    breastfeedingSafety: 'caution',
    dosageGuidelines: '200-400mg daily standardized to rosavins/salidroside',
    qualityStandards: ['Standardized 3% rosavins/1% salidroside', 'Third-party tested']
  },
  {
    id: 'hi16',
    herb: 'Holy Basil',
    ...
    interactsWith: ['Anticoagulants (caution)'],
    contraindications: ['Pre-surgery (bleeding risk)'],
    warnings: ['May lower blood sugar and stress markers'],
    pregnancySafety: 'caution',
    breastfeedingSafety: 'caution',
    dosageGuidelines: '300-600mg extract or tea 1-2x/day',
    qualityStandards: ['Organic certified', 'Pesticide tested']
  },
  {
    id: 'hi17',
    herb: 'Maca',
    commonName: 'Maca Root',
    scientificName: 'Lepidium meyenii',
    interactsWith: ['Hormone therapies (caution)'],
    contraindications: ['Thyroid disorders (goitrogens, caution)'],
    warnings: ['May affect hormones subtly'],
    pregnancySafety: 'caution',
    breastfeedingSafety: 'caution',
    dosageGuidelines: '1500-3000mg powder daily',
    qualityStandards: ['Gelatinized for digestion', 'Heavy metal tested']
  },
  {
    id: 'hi18',
    herb: 'Schisandra',
    commonName: 'Schisandra Berry',
    scientificName: 'Schisandra chinensis',
    interactsWith: ['CYP450 substrates (caution)'],
    contraindications: ['GERD (may worsen)'],
    warnings: ['May alter drug metabolism'],
    pregnancySafety: 'avoid',
    breastfeedingSafety: 'caution',
    dosageGuidelines: '500-1000mg extract daily',
    qualityStandards: ['Standardized to schisandrins']
  },
  {
    id: 'hi19',
    herb: 'Hawthorn',
    ...
    interactsWith: ['Cardiac glycosides', 'Antihypertensives'],
    contraindications: ['Combine with cardiac meds only under supervision'],
    warnings: ['May potentiate cardiac drugs'],
    pregnancySafety: 'caution',
    breastfeedingSafety: 'caution',
    dosageGuidelines: '160-900mg extract daily (leaf/flower)',
    qualityStandards: ['Standardized to flavonoids/procyanidins']
  },
  {
    id: 'hi20',
    herb: 'Nettle',
    ...
    interactsWith: ['Diuretics', 'Antidiabetics'],
    contraindications: ['Kidney disorders (caution)'],
    warnings: ['Diuretic effect; monitor blood sugar'],
    pregnancySafety: 'caution',
    breastfeedingSafety: 'caution',
    dosageGuidelines: '300-600mg leaf extract or tea',
    qualityStandards: ['Proper identification (leaf vs root)']
  },
  {
    id: 'hi21',
    herb: 'Lion\'s Mane',
    ...
    warnings: ['May increase NGF-related activity (theoretical)'],
    pregnancySafety: 'unknown',
    breastfeedingSafety: 'unknown',
    dosageGuidelines: '500-3000mg fruiting body extract daily',
    qualityStandards: ['Fruiting body only, beta-glucan standardized']
  },
  {
    id: 'hi22',
    herb: 'Reishi',
    ...
    interactsWith: ['Anticoagulants', 'Immunosuppressants'],
    contraindications: ['Bleeding disorders'],
    warnings: ['May increase bleeding risk; immunomodulating'],
    pregnancySafety: 'caution',
    breastfeedingSafety: 'caution',
    dosageGuidelines: '1000-3000mg extract daily',
    qualityStandards: ['Fruiting body, beta-glucan standardized']
  },
  {
    id: 'hi23',
    herb: 'Astragalus',
    commonName: 'Astragalus Root',
    scientificName: 'Astragalus membranaceus',
    interactsWith: ['Immunosuppressants'],
    contraindications: ['Autoimmune disease (caution)'],
    warnings: ['Immune-stimulating'],
    pregnancySafety: 'caution',
    breastfeedingSafety: 'caution',
    dosageGuidelines: '500-1000mg extract daily',
    qualityStandards: ['Standardized to astragalosides']
  },
  {
    id: 'hi24',
    herb: 'Green Tea',
    ...
    interactsWith: ['Warfarin', 'Stimulants'],
    contraindications: ['Anxiety/insomnia (caffeine)'],
    warnings: ['Caffeine-related side effects; liver risk with high-dose extracts'],
    pregnancySafety: 'caution',
    breastfeedingSafety: 'caution',
    dosageGuidelines: 'Tea 1-3 cups/day; extract 250-500mg EGCG/day',
    qualityStandards: ['EGCG standardized; tested for contaminants']
  },
  {
    id: 'hi25',
    herb: 'Fenugreek',
    ...
    interactsWith: ['Anticoagulants', 'Antidiabetics'],
    contraindications: ['Bleeding disorders', 'Pregnancy (high doses)'],
    warnings: ['May lower blood sugar and increase bleeding risk'],
    pregnancySafety: 'caution',
    breastfeedingSafety: 'safe',
    dosageGuidelines: '500-1000mg extract daily',
    qualityStandards: ['Standardized to 50% fenusides (varies)']
  }
];