...
import { Pill, FlaskConical, ShieldCheck, Info, Dna, Moon } from 'lucide-react-native';

import { colors } from '@/constants/colors';
import { Card } from '@/components/ui/Card';
import { Badge } from '@/components/ui/Badge';
import { preworkoutGuide, proteinGuide, fiberGuide, safetyNotes, aminoAcidsGuide, neuroSleepGuide, IngredientGuide, DosageRange } from '@/constants/supplementGuides';
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} testID="SupplementGuideScreen">
      ...
      <Card style={styles.headerCard}>
        <View style={styles.headerRow}>
          ...
          <Text style={styles.sectionTitle}>{neuroSleepGuide.title}</Text>
        </View>
        <Text style={styles.sectionSubtitle}>{neuroSleepGuide.subtitle ?? ''}</Text>
      </Card>

      <Card style={styles.sectionCard}>
        {neuroSleepGuide.items.map((it) => (
          <IngredientItem key={it.id} item={it} />
        ))}
      </Card>
